...
use nix::{pty::Winsize, sys::termios, sys::termios::LocalFlags, sys::termios::InputFlags, sys::termios::OutputFlags, sys::termios::ControlFlags};
...
fn enable_raw_mode() -> Result<termios::Termios, Error> {
    ...
    let flags = [InputFlags::BRKINT, InputFlags::INPCK, InputFlags::ISTRIP, InputFlags::IXON,  InputFlags::ICRNL];
    for flag in flags.iter(){
